...
public class ElbowIOFX implements ElbowIO {
    ...
    MotionMagicDutyCycle positionRequst = new MotionMagicDutyCycle(0).withEnableFOC(false).withFeedForward(0).withSlot(0);
    ...
    public void zero() {
        ...
        logger.info("Abs: {}, Zero Pos: {}, Offset: {}", absSesorInitial, ElbowConstants.kElbowZeroTicks, relSetpointOffset);
    }
