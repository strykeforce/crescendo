...
public class MiddleFourPieceCommand extends SequentialCommandGroup implements AutoCommandInterface {
  ...
  private DriveAutonCommand wingNote1WingNote2;
  ...
  public MiddleFourPieceCommand(
    ...
    wingNote1WingNote2 = new DriveAutonCommand(driveSubsystem, "WingNote1_Leave", true, false);
    midNote1ShootPos =
  ...
  public void generateTrajectory() {
    ...
    wingNote1WingNote2.generateTrajectory();
    hasGenerated = true;
